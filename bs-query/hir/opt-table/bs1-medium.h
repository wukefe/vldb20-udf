...
static V horse_bs1_medium(V t0){
...
static I horse_main(V *h_rtn){
    ...
    PROFILE(13, pfnTable(result, columnname, columnvalue));
    h_rtn[0] = horse_bs1_medium(result);
    return 0;
}
